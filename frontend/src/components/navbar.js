    ...
    <div>
        <aside class=" w-52" aria-label="Sidebar">
            <div class=" h-full overflow-y-auto py-4 px-3 bg-gray-700 rounded dark:bg-gray-800 opacity-70">
                ...
                <ul class="space-y-2">
                    <li>
                        <button class=" w-44 bg-slate-400 flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-50 dark:hover:bg-gray-700">
                    ...
                    <li>
                        <button class="w-44 bg-slate-400 flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
